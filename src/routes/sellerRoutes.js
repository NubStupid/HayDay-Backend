...
const { buyItem, editRequest, updateItem, deleteSellerItem, getItem, getItems } = require("../controllers/sellerController");
...
router.put("/item/buy", [middleware.verifyToken, middleware.verifyUser, middleware.verifyRole("Seller")], editRequest);
